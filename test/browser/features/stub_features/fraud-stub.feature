...
Feature: Fraud CRI - Happy Path Tests
  ...
  @stub-test
  Scenario Outline: Fraud CRI - STUB - Happy Path - Run Fraud check by userId <expectedGivenName> <expectedFamilyName>
  ...
  @stub-test
  Scenario Outline: Fraud CRI - STUB - Happy Path - Run Fraud check by user search <expectedGivenName> <expectedFamilyName>
  ...
  @stub-test
  Scenario Outline: Fraud CRI - STUB - Happy Path - Run Fraud check by edit user <expectedGivenName> <expectedFamilyName>
    Given I search for user name <userName> in the ThirdParty table
